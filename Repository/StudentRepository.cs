    ...
    public class StudentRepository : BaseRepository, IStudentRepository
    {
        ...
        public void InsertStudent(Student student, ref List<string> errors)
        {
            ...
            try
            {
                ...
                adapter.SelectCommand.Parameters.Add(new SqlParameter("@student_level", SqlDbType.VarChar, 20));
                adapter.SelectCommand.Parameters.Add(new SqlParameter("@student_category", SqlDbType.VarChar, 20));
                ...
                adapter.SelectCommand.Parameters["@student_level"].Value = student.StudentLevel;
                adapter.SelectCommand.Parameters["@student_category"].Value = student.StudentCategory;
        ...
        public Student GetStudentDetail(string id, ref List<string> errors)
        {
            ...
            try
            {
                ...
                student = new Student
                {
                    ...
                    ShoeSize = (float)Convert.ToDouble(dataSet.Tables[0].Rows[0]["shoe_size"]),
                    Weight = (int)dataSet.Tables[0].Rows[0]["weight"],
                    StudentLevel = dataSet.Tables[0].Rows[0]["student_level"].ToString(),
                    StudentCategory = dataSet.Tables[0].Rows[0]["student_category"].ToString()
                };
                ...
                /*   if (dataSet.Tables[1] != null)
                   {
                       ...
                       for (var i = 0; i < dataSet.Tables[1].Rows.Count; i++)
                       {
                           ...
                           var course = new Course
                                            {
                                                CourseId = (int)dataSet.Tables[1].Rows[i]["course_id"],
            ...
            try
            {
                ...
                for (var i = 0; i < dataSet.Tables[0].Rows.Count; i++)
                {
                    var student = new Student
                    {
                        ...
                        ShoeSize = (float)Convert.ToDouble(dataSet.Tables[0].Rows[i]["shoe_size"]),
                        Weight = (int)dataSet.Tables[0].Rows[i]["weight"],
                        StudentLevel = dataSet.Tables[0].Rows[i]["student_level"].ToString(),
                        StudentCategory = dataSet.Tables[0].Rows[i]["student_category"].ToString()
                    };
